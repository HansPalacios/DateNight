...
Venue.create([
	...
	{id: 7, name: "New York Comedy Club", bio: "Pro stand-up comedians perform on a red-brick-backed stage at this longtime club with a snug bar.", address: "241 E 24th St, New York, NY 10010", phone:"(212) 696-5233", image: File.new("#{Rails.root}/images/nycc.jpg"), google_rating: 4.2, yelp_rating: 4, website: "newyorkcomedyclub.com", sponsor: true},
	...
	{id: 16, name: "Dave & Busters", bio: "Family-friendly chain offering a sports-bar-style setting for American food & arcade games.", address: "234 W 42nd St, New York, NY 10036", phone:"(646) 495-2015", image: File.new("#{Rails.root}/images/davebusters.jpg"), google_rating: 3.8, yelp_rating: 3, website: "daveandbusters.com", sponsor: true},
	...
	{id: 29, name: "Wild Ginger", bio: "Stylish, casual eatery offering vegan Asian-style dishes, plus creative juice blends & smoothies.", address: "182 N 10th St, Brooklyn, NY 11211", phone:"", image: File.new("#{Rails.root}/images/wildgingerwilliamsburg.jpg"), google_rating: 4.3, yelp_rating: 3.5, website: "wildgingerny.com", sponsor: true},
	...
	{id: 42, name: "Sound Of Brazil", bio: "Latin food & drink accompany live & DJ'ed sets of world music & hip-hop at this longtime club.", address: "204 Varick St, New York, NY 10014", phone:"(212) 243-4940", image: File.new("#{Rails.root}/images/sobs.jpg"), google_rating: 3.9, yelp_rating: 3.5, website: "sobs.com", sponsor: true},
