...
Venue.create([
	{name: 'Le Bain', bio: '
Theres a disco, bar, (seasonal) plunge pool & crêperie, all on the roof of the Standard Hotel.', address: 'The Standard, High Line, 848 Washington St, New York, NY 10014', phone: '(212) 645-7600'},
	{name: 'Marquee', bio: 'Colorful, multi-tiered dance club featuring 30-foot ceilings, LED screens & plenty of night owls.', address: '289 10th Avenue, New York, NY 10001', phone:'(646) 473-0202'},
	{name: 'Manhattan Kayak + SUP', bio: 'Evening and night tours of the manhattan skyline, or a day trip to the statue of liberty', address: '555 12th Ave, New York, NY 10019', phone:'(212) 924-1788'}
	])
